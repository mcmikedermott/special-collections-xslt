    ...
    <xsl:template match="ead:revisiondesc |
        ...
        <xsl:call-template name="panel-data-row">
            ...
            <xsl:with-param name="title-flag">
                <xsl:choose>
                    <xsl:when test="self::ead:accessrestrict"><span class="fa fa-exclamation-triangle"/></xsl:when>
                    <xsl:when test="self::ead:userestrict"><span class="fa fa-exclamation-triangle"/></xsl:when>
                </xsl:choose>
            </xsl:with-param>
            <xsl:with-param name="content">
