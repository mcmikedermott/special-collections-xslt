            ...
            <body>
                <div id="main">
                    ...
                    <div id="content-right">
                        <a name="top"> </a>
                        <div id="title">
                            <a href="http://bowdoin.edu">
                            <img src="http://www.bowdoin.edu/lib/img/homepage/bowdoin-wordmark-295x60.png" alt=""/></a>
        ...
        <div id="toc">
            ...
            <dl>
                <xsl:if test="/ead:ead/ead:archdesc/ead:did">
                    <dt><a href="#top">Summary Information</a></dt>
                </xsl:if>
